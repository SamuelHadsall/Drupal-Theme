...
---------------------------------------------------------------------------*/
   ...
   var g_map_highlightRGB = [5,64,92];       // state color when highlighted
   ...
   function map_userSetup()
   {
      ...
      g_map_stateMap["AL"].addInfoBoxText("HOUSING & MIXED USE");
	  g_map_stateMap["AL"].addInfoBoxText("Senior Living Tower - Tuscaloosa, AL");
	  g_map_stateMap["AL"].addInfoBoxText("");
	  g_map_stateMap["AL"].addInfoBoxText("Products used: BB5 Hinges, X & V Series Locks HOSPITALITY Candlewood Suites - Birmingham, AL Products used: X & V Series Locks, 1000 Series Exit Devices & Trim, 316 Series Closers, Flat Goods");
      ...
      for ( var abbrev in g_map_stateMap )
      {
		 ...
		 g_map_stateMap["AL"].myInfoBoxOrigin = [325,90];
		 g_map_stateMap["AL"].myInfoBoxHeight = 500; 
